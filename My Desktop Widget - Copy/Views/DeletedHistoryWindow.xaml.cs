    ...
    public partial class DeletedHistoryWindow : Window
    {
        ...
        private async void BtnRestore_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                // FIX LỖI CONFLICT: Tạo một object Event mới tinh, chỉ bê nội dung sang
                var eventToRestore = new Event
                {
                    ...
                    // Id và ETag sẽ để mặc định là null để Google tự cấp mới
                };

                await service.Events.Insert(eventToRestore, "primary").ExecuteAsync();
